/**
 * @file    wifi.c
 * @brief   WiFi management functions.
 *
 * @details This file contains functions for initializing and handling WiFi
 *          events such as connection, disconnection, and smartconfig.
 */

#include "wifi.h"

EventGroupHandle_t s_wifi_event_group; /**< Event group for WiFi events */
static const char *TAG = "WIFI";       /**< Logging tag for WiFi */

/**
 * @brief WiFi event handler function.
 *
 * This function handles various WiFi events such as connection, disconnection,
 * and smartconfig events.
 *
 ...
 *
 * This function initializes the WiFi subsystem, sets up event handling,
