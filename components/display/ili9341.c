 ...
 * Variables
 ******************************************************************************/
const char *TAG_LCD = "example"; /**< Tag for logging LCD related messages. */
SemaphoreHandle_t lvgl_mux = NULL; /**< Semaphore mutex for LVGL synchronization. */
...
/**
 * @brief Notifies LVGL that the flush operation is ready.
 *
...
/**
 * @brief Callback function for flushing LVGL display.
 *
 * @param drv           Display driver structure pointer.
 * @param area          Area to be flushed.
 * @param color_map     Array of colors.
 */
...
/**
 * @brief Increases LVGL tick count.
 *
...
{
    static lv_disp_draw_buf_t disp_buf; /**< Draw buffer for LVGL. */
...
/**
 * @brief Task to handle sensor data display.
 *
